...
START_OTHER_USERS_TEXT = get_config(
    ...
    (
        ...
        "https://github.com/SUKHPAL443/MAMBASTRINGPRO\n"
        "ℹ️ FOLLOW @https://github.com/SUKHPAL443 if you 😍 using this bot❗️❣️"
    )
)
...
ACC_PROK_WITH_TFA = get_config("ACC_PROK_WITH_TFA", (
    ...
    "https://github.com/SUKHPAL443/MAMBASESSIONPRO and not "
    "use this hosted version"
))
SESSION_GENERATED_USING = get_config("SESSION_GENERATED_USING", (
    "Thank you for using me 😬\n\n"
    "This is an Closed Source Project available on "
    "https://github.com/SUKHPAL443/MAMBASESSIONPRO\n\n\n"
